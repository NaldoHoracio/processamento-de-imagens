...
folder = "home/horacio/Documentos/4-PROCESSAMENTO_DE_IMAGENS-8-/AB2/Questões_de_revisão"
...
img = cv2.imread(folder + '2.png', cv2.IMREAD_GRAYSCALE)
...
# %% Quarta Questao
img = cv2.imread(folder + "4.png", cv2.IMREAD_COLOR)
