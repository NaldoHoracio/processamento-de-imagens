# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 17:36:39 2019
...
from __init__ import LeNet5     # ESTA É A CLASSE CRIADA POR NÓS
...
H = model.fit(trainX, trainY, batch_size=128, epochs=5, verbose=2,
